...
int main() {
  ...
  printf("(%lf)\n", res);
//   double *mounth_sum = malloc(sizeof(double));
//   int *mounth_s = malloc(sizeof(int));
//   *mounth_sum = 0;
//   double *total_payment = malloc(sizeof(double));
//   *total_payment = 0;
//   double *overpayment = malloc(sizeof(double));
//   *overpayment = 0;
//   int m = 2;
//   char *tmp = "";
//   char *p = ";";
//   depositNoCapitalization(100000, 15, 10, 12, overpayment, total_payment); 
// char *replenishment_list = "12:1245;    03:3214;=";
//     while (replenishment_list != NULL) {
//         // if (*replenishment_list == ' ') {
//         //     replenishment_list++;
//         // }
//         // while (*replenishment_list != ';') {
//             tmp = strtok(replenishment_list, p);
//         //     replenishment_list++;
//         // }
//         // tmp = replenishment_list;
//             parseDatesAndAmounts(tmp, mounth_s, total_payment);
//             printf("%d\n", *mounth_s);
//             printf("%lf\n", *total_payment);
//             printf("(%c)", *tmp);
//             replenishment_list++;
